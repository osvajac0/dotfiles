...
static const unsigned int borderalpha = 210;
...
char *colors[][2] = {
	/*               fg         bg       */
	[SchemeNorm] = { "#636b6a", "#000000" },
	[SchemeSel]  = { "#cccccc", "#121212" },
